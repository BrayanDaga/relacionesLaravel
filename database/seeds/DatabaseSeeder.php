...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(App\User::class,5)->create()->each(function($user){
            ...
            $profile->groups()->attachj($this->array(rand(1,3)));
            
            $user->image()->save(factory(App\Image::class)->make(['url' =>
            'https://lorempixel.com/90/90']));
        ...
        factory(App\Post::class,40)->create()->each(function($post){
            ...
            $number_coments = rand(1,6);

            for ($i=0; $i <$number_coments ; $i++) { 
